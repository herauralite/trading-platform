...
CONNECTOR_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "alpaca_api": {
        ...
        "requires_bridge": False,
        "beta": True,
        "integration_status": "beta_read_only_account_validation",
        "connection_layer": "public_api_connector",
        "supported_capabilities": ["credential_validation", "account_summary_read_only"],
        "onboarding_copy": "Connect read-only Alpaca API credentials and validate account access.",
        "connection_state_labels": {
            "paper_connected": "Paper connected",
